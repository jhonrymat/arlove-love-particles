/******/ (function(modules) {
  ...
  /******/ [
      ...
      AFRAME.registerComponent("particle-system", {
        ...
        init: function() {
          ...
          if (this.data.size.length) {
            for (let i = 0; i < this.data.size.length; i++)
              this.data.size[i] = parseInt(this.data.size[i], 10);
          }
          if (this.data.opacity.length) {
            for (let i = 0; i < this.data.opacity.length; i++)
              this.data.opacity[i] = parseInt(this.data.opacity[i], 10);
          }

          this.presets["default"] = {
            maxAge: this.data.maxAge !== 0 ? this.data.maxAge : 6,
            positionSpread:
              this.data.positionSpread.x !== 0 ||
              this.data.positionSpread.y !== 0 ||
              this.data.positionSpread.z !== 0
                ? this.data.positionSpread
                : { x: 0, y: 0, z: 0 },
            type:
              this.data.type !== 0
                ? this.data.type
                : SPE.distributions
                    .BOX /* SPE.distributions.SPHERE, SPE.distributions.DISC */,
            rotationAxis:
              this.data.rotationAxis !== "" ? this.data.rotationAxis : "x",
            rotationAngle:
              this.data.rotationAngle !== 0 ? this.data.rotationAngle : 0,
            accelerationValue:
              this.data.accelerationValue.x !== 0 ||
              this.data.accelerationValue.y !== 0 ||
              this.data.accelerationValue.z !== 0
                ? this.data.accelerationValue
                : { x: 0, y: -10, z: 0 },
            accelerationSpread:
              this.data.accelerationSpread.x !== 0 ||
              this.data.accelerationSpread.y !== 0 ||
              this.data.accelerationSpread.z !== 0
                ? this.data.accelerationSpread
                : { x: 10, y: 0, z: 10 },
            velocityValue:
              this.data.velocityValue.x !== 0 ||
              this.data.velocityValue.y !== 0 ||
              this.data.velocityValue.z !== 0
                ? this.data.velocityValue
                : { x: 0, y: 25, z: 0 },
            velocitySpread:
              this.data.velocitySpread.x !== 0 ||
              this.data.velocitySpread.y !== 0 ||
              this.data.velocitySpread.z !== 0
                ? this.data.velocitySpread
                : { x: 10, y: 7.5, z: 10 },
            color: this.data.color.length
              ? this.data.color
              : ["#0000FF", "#FF0000"],
            size: this.data.size.length ? this.data.size : [1],
            opacity: {
              value: this.data.opacity.length ? this.data.opacity : [1]
            },
            direction: this.data.direction !== 0 ? this.data.direction : 1,
            duration: this.data.duration != 0 ? this.data.duration : null,
            particleCount:
              this.data.particleCount !== 0 ? this.data.particleCount : 1000,
            texture:
              this.data.texture !== ""
                ? this.data.texture
          ...
          this.presets["dust"] = {
            ...
            rotationAxis:
              this.data.rotationAxis !== "" ? this.data.rotationAxis : "x",
            rotationAngle:
              this.data.rotationAngle !== 0 ? this.data.rotationAngle : 3.14,
            accelerationValue:
              this.data.accelerationValue.x !== 0 ||
              this.data.accelerationValue.y !== 0 ||
              this.data.accelerationValue.z !== 0
            ...
            duration: this.data.duration != 0 ? this.data.duration : null,
            particleCount:
              this.data.particleCount !== 0 ? this.data.particleCount : 100,
            texture:
              this.data.texture !== ""
                ? this.data.texture
          ...
          this.presets["snow"] = {
            ...
            duration: this.data.duration != 0 ? this.data.duration : null,
            particleCount:
              this.data.particleCount !== 0 ? this.data.particleCount : 200,
            texture:
              this.data.texture !== ""
                ? this.data.texture
                : "https://cdn.rawgit.com/IdeaSpaceVR/aframe-particle-system-component/master/dist/images/smokeparticle.png",
          ...
          var emitter = new SPE.Emitter({
            ...
            position: {
              spread: new THREE.Vector3(
                settings.positionSpread.x,
                settings.positionSpread.y,
                settings.positionSpread.z
              ),
            ...
            rotation: {
              axis:
                settings.rotationAxis == "x"
                  ? new THREE.Vector3(1, 0, 0)
                  : settings.rotationAxis == "y"
                  ? new THREE.Vector3(0, 1, 0)
                  : settings.rotationAxis == "z"
            ...
            acceleration: {
              value: new THREE.Vector3(
                settings.accelerationValue.x,
                settings.accelerationValue.y,
                settings.accelerationValue.z
              ),
              spread: new THREE.Vector3(
                settings.accelerationSpread.x,
                settings.accelerationSpread.y,
                settings.accelerationSpread.z
              )
            },
            velocity: {
              value: new THREE.Vector3(
                settings.velocityValue.x,
                settings.velocityValue.y,
                settings.velocityValue.z
              ),
              spread: new THREE.Vector3(
    ...
    /***/ function(module, exports, __webpack_require__) {
       ...
       */
      SPE.TypedArrayHelper.prototype.setSize = function(
        size,
        noComponentMultiply
      ) {
        "use strict";
       ...
       * @return {SPE.TypedArrayHelper} Instance of this class.
       */
      SPE.TypedArrayHelper.prototype.setVec3Components = function(
        index,
        x,
        y,
        z
       ...
       * @return {SPE.TypedArrayHelper} Instance of this class.
       */
      SPE.TypedArrayHelper.prototype.setVec4Components = function(
        index,
        x,
        y,
        z,
       ...
       */
      SPE.TypedArrayHelper.prototype.getComponentValueAtIndex = function(
        index
      ) {
        "use strict";
      ...
      SPE.ShaderAttribute = function(type, dynamicBuffer, arrayType) {
        ...
        this.type =
          typeof type === "string" && typeMap.hasOwnProperty(type) ? type : "f";
       ...
       * @return {Group} This group instance.
       */
      SPE.Group.prototype.addPool = function(
        numEmitters,
        emitterOptions,
        createNew
      ) {
      ...
      SPE.Emitter = function(options) {
        ...
        options.opacity = utils.ensureTypedArg(
          options.opacity,
          types.OBJECT,
          {}
        );
        ...
        this.direction = utils.ensureTypedArg(
          options.direction,
          types.NUMBER,
          1
        );
      ...
      SPE.Emitter.prototype._assignAbsLifetimeValue = function(
        index,
        propName
      ) {
        "use strict";
      ...
      SPE.Emitter.prototype._checkParticleAges = function(
        start,
        end,
        params,
        dt
